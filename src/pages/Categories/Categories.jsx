  ...
  const CategoriesPages = [
    {
      ...
      slogan: "Designs to make you stand out.",
      banner:
    ...
    },
    {
      ...
      slogan: "Build your brand. Grow your business.",
      banner:
    ...
    },
    {
      ...
      slogan: "Get your words across—in any language.",
      banner:
    ...
    },
    {
      ...
      slogan: "Bring your story to life with creative videos.",
      banner:
    ...
    },
    {
      ...
      name: "Music & Audio",
      slogan: "Don't miss a beat. Bring your sound to life.",
      banner:
    ...
    {
      id: 6,
      url: "/categories/programing-tech",
      name: "Programming & Tech",
      slogan: "You think it. A programmer develops it.",
      banner:
    ...
    {
      id: 8,
      url: "/categories/Life Style",
      name: "Lifestyle",
      slogan: "Your life. Your style. Find the balance",
      banner:
    ...
    if (page.url === props.match.url) {
      return (
        ...
        >
          ...
          <div
            className="cate-video-container"
            id="cate-video"
            onClick={() => {
